...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public List<AttrEntity> getRelationAttr(Long attrgroupId) {
        // 1. 根据属性组编号从属性组和基本信息的关联表中查询出对应的属性信息
    ...
    /**
     * 查询属性信息
     * 如果查询基本属性（attrType:base），还需要查询出关联的类别信息和属性组信息
     * @param params
     * @param catelogId
     * @param attrType
     * @return
    ...
    /**
     * 删除属性信息
     * 如果删除的是基本属性，还需要删除属性组和基本属性关联表的数据
     * @param attrIds
     */
    @Transactional
    @Override
