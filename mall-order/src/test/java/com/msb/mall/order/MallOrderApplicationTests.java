...
class MallOrderApplicationTests {
	...
	void sendMsgSync() throws Exception{
		...
		// 设置NameServer的地址
		producer.setNamesrvAddr("192.168.153.178:9876");
		// 启动Producer实例
		producer.start();
		for (int i = 0; i < 100; i++) {
	...
	@Test
	void consumerMsg() throws Exception{
		// 实例化消费者
		DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("orderGroup1");

		// 设置NameServer的地址
		consumer.setNamesrvAddr("192.168.153.178:9876");
	...
	@Test
	void consumerDelayMsg() throws Exception{
		// 实例化消费者
	...
	@Test
	void producerDelayMsg() throws Exception{
		// 实例化一个生产者来产生延时消息
